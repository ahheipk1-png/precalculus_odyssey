  ...
  (function(){
    ...
    G[77] = function(){ var a = ri(2,10); return num('x² − ' + (a * a) + ' = 0.   The positive solution is  x = ?', a); };
    ...
    G[84] = function(){ var a = ri(2,6), b = ri(2,6); return num('x² − ' + (a + b) + 'x + ' + (a * b) + ' = 0.   The LARGER root is  x = ?', Math.max(a, b)); };
    ...
    G[87] = function(){ var a = ri(1,4), b = ri(1,5), x = ri(2,4); return num('If P(x) = x² + ' + a + 'x + ' + b + ', find P(' + x + ').', x * x + a * x + b); };
    ...
    G[89] = function(){ var a = ri(2,6), b = ri(2,6); return num('x² − ' + (a + b) + 'x + ' + (a * b) + ' = 0.   The SMALLER root is  x = ?', Math.min(a, b)); };
    ...
    G[91] = function(){ var b = ri(1,5), c = ri(1,5); return mc('Which expression is a QUADRATIC?', 'x² + ' + b + 'x + ' + c, [b + 'x + ' + c, 'x³ − ' + c, '' + (b + c)]); };
    ...
    G[94] = function(){ var p = ri(1,6), q = ri(1,6); while (q === p) q = ri(1,6); return mc('For (x − ' + p + ')(x + ' + q + ') = 0, the roots are…', 'x = ' + p + '  or  x = −' + q, ['x = −' + p + '  or  x = ' + q, 'x = ' + p + '  or  x = ' + q, 'x = −' + p + '  or  x = −' + q]); };
    G[95] = function(){ var p = ri(2,7), q = ri(1,6); return num('(x − ' + p + ')(x + ' + q + ') = 0.   The positive root is  x = ?', p); };
    G[96] = function(){ var a = ri(2,6), b = ri(2,6); return num('x² − ' + (a + b) + 'x + ' + (a * b) + ' = 0.   The larger root is  x = ?', Math.max(a, b)); };
    ...
    G[101] = function(){ var r = ri(2,12); return num('x² = ' + (r * r) + '.   The positive value of x = ?', r); };
    ...
    G[107] = function(){ return mc('If the discriminant of a quadratic is POSITIVE, how many real roots does it have?', 'Two', ['One', 'None', 'Infinitely many']); };
    ...
    G[109] = function(){ var a = ri(2,6), b = ri(2,6); return num('Using the quadratic formula, solve x² − ' + (a + b) + 'x + ' + (a * b) + ' = 0.   The larger root = ?', Math.max(a, b)); };
    G[110] = function(){ var a = ri(2,6), b = ri(2,6); return num('x² − ' + (a + b) + 'x + ' + (a * b) + ' = 0.   Work out the discriminant, then give the larger root.', Math.max(a, b)); };
    ...
    G[116] = function(){ var b = ri(0,5), x = ri(1,5); return num('f(x) = x² + ' + b + '.   Find f(' + x + ').', x * x + b); };
    ...
    G[124] = function(){ var y = ri(1,6); return mc('A parabola opens UPWARD with lowest point y = ' + y + '. Its range is…', 'y ≥ ' + y, ['y ≤ ' + y, 'all values of y', 'y > 0']); };
    ...
    G[129] = function(){ return mc('At most how many times can a quadratic (degree 2) cross the x-axis?', '2', ['1', '3', '0']); };
    ...
    G[155] = function(){ return mc('In a right triangle, the longest side (opposite the right angle) is the…', 'hypotenuse', ['opposite', 'adjacent', 'base']); };
    G[156] = function(){ return mc('sin θ = ?', 'opposite ÷ hypotenuse', ['adjacent ÷ hypotenuse', 'opposite ÷ adjacent', 'hypotenuse ÷ opposite']); };
    G[157] = function(){ var t = triple(); return num('A right triangle has legs ' + t[0] + ' and ' + t[1] + '. Find the hypotenuse.', t[2]); };
    G[158] = function(){ var t = triple(); return num('A right triangle has hypotenuse ' + t[2] + ' and one leg ' + t[0] + '. Find the other leg.', t[1]); };
    ...
    G[162] = function(){ return mc('On the unit circle, what is sin 90°?', '1', ['0', '1/2', '√3/2']); };
    ...
    G[172] = function(){ var r = ri(2,9); return num('For the circle  x² + y² = ' + (r * r) + ', what is the radius?', r); };
    ...
    G[174] = function(){ var t = ri(0,2); if (t === 0) return mc('Which conic is  x² + y² = 25?', 'Circle', ['Parabola', 'Ellipse', 'Straight line']); if (t === 1) return mc('Which conic is  y = x²?', 'Parabola', ['Circle', 'Ellipse', 'Straight line']); return mc('Which conic is  x²/9 + y²/4 = 1?', 'Ellipse', ['Circle', 'Parabola', 'Straight line']); };
    ...
    G[181] = function(){ return mc('A quadratic with a NEGATIVE discriminant has how many REAL roots?', 'None (0)', ['One', 'Two', 'Infinitely many']); };
